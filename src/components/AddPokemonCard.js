...
class AddPokemonCard extends React.Component {
  ...
  handleSave = () => {
    ...
    const trainer_id = this.props.params.trainerId
    this.props.mutate({variables: {name, url, trainer_id}})
      .then(() => {
...
const createPokemonMutation = gql`
  mutation addPokemon($name: String!, $url: String!, $trainer_id: String) {
    addPokemon(name: $name, url: $url, trainer_id: $trainer_id) {
      id
    }
  }
`
